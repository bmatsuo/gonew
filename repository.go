...
func (hg HgRepository) Initialize(add, commit bool) os.Error {
    var (
...
func (hg HgRepository) Add(paths ...string) os.Error {
    var cmdslice = make([]string, len(paths)+1)
    cmdslice[0] = "add"
    copy(cmdslice[1:], paths)
    var (
...
func (hg HgRepository) Commit(message string) os.Error {
    var (
